...
export default function TabTwoScreen() {
  return (
    <ParallaxScrollView
      ...
      <View style={{ gap: 16 }}>
        <Card title="Starter overview" subtitle="What's included">
        ...
        <Card title="Android, iOS, and web support">
          <ThemedText>
        ...
        <Card title="Light and dark mode components">
          <ThemedText>
        ...
        <Card title="Animations">
          <ThemedText>
            This template includes an example of an animated component. The <ThemedText type="defaultSemiBold">components/HelloWave.tsx</ThemedText> component uses the powerful <ThemedText type="defaultSemiBold" style={{ fontFamily: Fonts.mono }}>react-native-reanimated</ThemedText> library to create a waving hand animation.
          </ThemedText>
          {Platform.select({
            ios: (
              <ThemedText>
